...
function setupRevealAnimations() {
    const revealElements = document.querySelectorAll(".section-title, .about-text p, .contact-item, .skill-category h3, .service-card h3");
...
function showNotification(message, type = "info") {
    ...
    const isIndexForm = window.location.pathname.includes("index.html") || window.location.pathname === "/" || window.location.pathname === "";
...
function optimizeFontLoading() {
    ...
    if (!isMobileDevice() || navigator.connection?.effectiveType === "4g") {
        const fontPreloads = ["https://fonts.gstatic.com/s/inter/v12/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMw2boKoduKmMEVuLyfAZ9hiA.woff2"];
...
// enhanceAccessibility and skip-link removed
...
const phrases = ["Freelance Data Analyst", "Power BI Developer", "Excel Dashboard Specialist", "Data Cleaning Expert", "Python + AI Analyst"];
let currentPhrase = 0;
let currentChar = 0;
let isDeleting = !1;
const typeSpeed = 100;
