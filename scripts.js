        ...
        .then((projects) => {
            ...
            categories.forEach((category) => {
                ...
                <i class="${dashboardIcon}"></i>${dashboardText}
                        ...
                        // Optimize image loading for all projects
                        const imgTag = `<img src="${proj.image.split('/upload/')[0]}/upload/c_scale,w_auto,dpr_auto,f_auto,q_auto/${proj.image.split('/upload/')[1]}" alt="${proj.alt}" loading="lazy" itemprop="image" onload="console.log('Image loaded:', this.src, 'Natural size:', this.naturalWidth + 'x' + this.naturalHeight)" />`;
